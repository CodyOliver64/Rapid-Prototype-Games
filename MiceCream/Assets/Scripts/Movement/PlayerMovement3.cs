...
public class PlayerMovement3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        movement = new Vector3(0f, 0f, Input.GetAxis("Vertical3"));
        rotation = new Vector3(Input.GetAxis("Horizontal3"), 0f, 0f);
    ...
    private Vector3 MoveTowardTarget(Vector3 targetVector)
    {
        ...
        if (Input.GetKeyDown(KeyCode.Joystick2Button3) && isGrounded && moveSpeed >= 5f)
        {
