...
public class PlayerMovement2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        movement = new Vector3(0f, 0f, Input.GetAxis("Vertical2"));
        rotation = new Vector3(Input.GetAxis("Horizontal2"), 0f, 0f);
    ...
    private Vector3 MoveTowardTarget(Vector3 targetVector)
    {
        ...
        if (Input.GetKeyDown(KeyCode.Joystick1Button3) && isGrounded && moveSpeed >= 5f)
        {
