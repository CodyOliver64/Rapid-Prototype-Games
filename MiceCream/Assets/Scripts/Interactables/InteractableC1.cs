...
public class InteractableC1 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (isInRange3)
        {
            if (Input.GetKeyDown(getIceCreamKey3))
            {
                ...
                //P3Text.GetComponent<Text>().text = P1Score.ToString();
            }
        }
        ...
        if (isInRange4)
        {
            if (Input.GetKeyDown(getIceCreamKey4))
            {
                ...
                //P4Text.GetComponent<Text>().text = P1Score.ToString();
            }
        }
    }
    ...
    {
        if (other.gameObject.name == "Sophie" && mainBowl.P1Score == 6)
        {
            isInRange1 = true;
            other.transform.GetChild(5).gameObject.SetActive(true);
        }

        if (other.gameObject.name == "Charlie" && mainBowl.P2Score == 6)
        {
            isInRange2 = true;
            other.transform.GetChild(4).gameObject.SetActive(true);
        }

        if (other.gameObject.name == "Valli" && mainBowl.P3Score == 6)
        {
            isInRange3 = true;
            other.transform.GetChild(4).gameObject.SetActive(true);
        }

        if (other.gameObject.name == "Patrick" && mainBowl.P4Score == 6)
        {
            isInRange4 = true;
            other.transform.GetChild(4).gameObject.SetActive(true);
        }
